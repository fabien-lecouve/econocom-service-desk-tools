...
return [
    ...
    'attributes'             => [
        ...
        'background_color_id'      => 'couleur d\'arrière-plan',
        'birthday'                 => 'anniversaire',
        'body'                     => 'corps',
        'border_top_color_id'      => 'couleur de la bordure supérieure',
        ...
        'excerpt'                  => 'extrait',
        'external_phone'           => 'téléphone externe',
        'filter'                   => 'filtre',
        'finished_at'              => 'date de fin',
        'firstname'                => 'prénom',
        'font_color_id'            => 'couleur du texte',
        'gender'                   => 'genre',
        'grand_prize'              => 'grand prix',
        'group'                    => 'groupe',
        'hour'                     => 'heure',
        'internal_phone'           => 'téléphone interne',
        'image'                    => 'image',
        ...
        'is_knowledge_manager'     => 'Knowledge Manager',
        ...
        'language_id'              => 'langue',
        'languages'                => 'langues',
        'languages.*.language_id'  => 'langue',
        'languages.*.signature'    => 'signature',
        'languages.*.internal_phone_override' => 'téléphone interne',
        'languages.*.external_phone_override' => 'téléphone externe',
        'lastname'                 => 'nom de famille',
        'lesson'                   => 'leçon',
        'line_address_1'           => 'ligne d\'adresse 1',
        'line_address_2'           => 'ligne d\'adresse 2',
        'login'                    => 'identifiant',
        'memberships'              => 'affectations',
        'memberships.*.project_id' => 'projet',
        'memberships.*.role_id'    => 'rôle',
        'message'                  => 'message',
        'message_id'               => 'message',
        'message_type_id'          => 'type de message',
        ...
        'translations.*.language_id' => 'langue',
